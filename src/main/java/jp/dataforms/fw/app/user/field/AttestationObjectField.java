...
/**
 * AttestationObjectFieldフィールドクラス。
 *
 */
public class AttestationObjectField extends ClobField {

	/**
	 * フィールドコメント。
	 */
	private static final String COMMENT = "AttestationObject";
	/**
	 * コンストラクタ。
	 */
	public AttestationObjectField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public AttestationObjectField(final String id) {
		super(id);
