...
/**
 * CollectedClientDataFieldフィールドクラス。
 *
 */
public class CollectedClientDataField extends ClobField {

	/**
	 * フィールドコメント。
	 */
	private static final String COMMENT = "CollectedClientData";
	/**
	 * コンストラクタ。
	 */
	public CollectedClientDataField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public CollectedClientDataField(final String id) {
		super(id);
