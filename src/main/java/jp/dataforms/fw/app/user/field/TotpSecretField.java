...
/**
 * TotpSecretFieldフィールドクラス。
 *
 */
public class TotpSecretField extends VarcharField {

	/**
	 * フィールドコメント。
	 */
	private static final String COMMENT = "TOTPのSecret";
	/**
	 * コンストラクタ。
	 */
	public TotpSecretField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public TotpSecretField(final String id) {
		super(id, 1024);
