...
/**
 * RecoveryCodeFieldフィールドクラス。
 *
 */
public class RecoveryCodeField extends VarcharField {
	/**
	 * フィールド長。
	 */
	 ...
	 * フィールドコメント。
	 */
	private static final String COMMENT = "リカバリーコード";
	/**
	 * コンストラクタ。
	 */
	public RecoveryCodeField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public RecoveryCodeField(final String id) {
		super(id, LENGTH);
