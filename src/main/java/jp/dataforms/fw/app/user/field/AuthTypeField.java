...
/**
 * AuthTypeFieldフィールドクラス。
 *
 */
public class AuthTypeField extends VarcharField {
	/**
	 * フィールド長。
	 */
	 ...
	 * フィールドコメント。
	 */
	private static final String COMMENT = "認証タイプ";
	/**
	 * コンストラクタ。
	 */
	public AuthTypeField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public AuthTypeField(final String id) {
		super(id, LENGTH);
