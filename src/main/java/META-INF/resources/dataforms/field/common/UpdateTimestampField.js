/**
 * @fileOverview {@link UpdateTimestampField}クラスを記述したファイルです。
 */

'use strict';

import { TimestampField } from '../sqltype/TimestampField.js';

/**
 * @class UpdateTimestampField
 *
 * @extends TimestampField
 */
export class UpdateTimestampField extends TimestampField {
	/**
	 * コンストラクタ。
	 */
	constructor() {
